        ...
        self.control = ft.Container(
            content=ft.Column(
                controls=[
                    ft.Row(
                        controls=[
                            ft.Icon(ft.Icons.FOLDER_OPEN, size=13, color=Colors.TEXT_MUTED),
                            ft.Text(
                                "저장 경로",
                                size=Typography.SMALL,
                        ...
                        controls=[
                            ft.OutlinedButton(
                                ...
                                style=ft.ButtonStyle(
                                    ...
                                    text_style=ft.TextStyle(size=Typography.CAPTION, weight=Typography.MEDIUM),
                                    side=ft.BorderSide(width=1, color=Colors.BORDER),
                                ),
                            ),
                            ft.OutlinedButton(
                                content=ft.Text("변경"),
